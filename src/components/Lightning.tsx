    ...
    <>
      ...
      >
        ...
        >
          <circle
            ...
            cy="12"
            r="10"
            className="fill-purple-500 dark:fill-orange-500"
          />
          <path
      ...
      >
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="fixed transform -translate-y-1/4 w-full max-w-sm md:max-w-md bg-white dark:bg-zinc-800 rounded-lg shadow-xl p-6 text-base font-semibold text-zinc-900 dark:text-zinc-100">
            <button
              onClick={() => setIsOpen(false)}
              className="absolute z-10 top-5 right-5 w-8 h-8 flex items-center justify-center text-zinc-500 hover:text-zinc-600 hover:dark:text-zinc-300"
            >
              ...
              <div className="mt-8">
                ...
                <div className="mt-3 ">
                  <input
                    ...
                    required
                    min={1}
                    className="block w-full sm:py-3 shadow-sm sm:text-sm focus:ring-purple-300 focus:border-purple-300 border-zinc-300 rounded-md dark:border-zinc-600 dark:bg-zinc-800 dark:focus:ring-orange-400 dark:focus:border-orange-400 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                  />
      ...
      >
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="fixed transform -translate-y-1/4 w-full max-w-sm md:max-w-md bg-white dark:bg-zinc-800 rounded-lg shadow-xl p-6 text-base font-semibold">
            <button
            ...
            <h4 className="text-lg bg-green-100 dark:bg-green-400/25 text-green-300 text-center py-4 rounded-md">{`You sent ${tippedAmount} sats!`}</h4>
            <h5 className="text overflow-x-scroll rounded-md text-center py-4">
              <div className="cursor-text bg-zinc-100 dark:bg-zinc-700 rounded-md flex justify-start items-center w-full">
                <div className="py-2 pl-2 mr-2 whitespace-nowrap">
                  Payment Hash:
                </div>
                <div className="py-4 pr-4 whitespace-nowrap bg-zinc-100 dark:bg-zinc-700 rounded-md">
                  {paymentHash}
                </div>
              </div>
            </h5>
